...
?> <div class="row">
    <div class="col-lg-12">
        ...
        <!-- Author -->
        <p class="lead"> by <a href="#">Steve</a>
        </p>
        <hr>
        <!-- Date/Time -->
        ...
        <hr>
        <!-- Posted Comments --> <?php foreach ($comments as $comment) : ?>
        <!-- Comment -->
        <div class="media">
            ...
            <div class="media-body">
                <h4 class="media-heading"><?php echo $comment->author; ?> <small>August 25, 2030 at 9:30 PM</small>
